...
namespace CheckSPNs.Authentication.Service
{
    public class TokenHandler : ITokenHandler
    {
        ...
        public TokenHandler(IConfiguration configuration, UserManager<AppUsers> userManager)
        {
            _configuration = configuration;
            _userManager = userManager;
        }

        public async Task<string> CreateAccessToken(AppUsers user)
        {
        ...
        public async Task<string> CreateRefreshToken(AppUsers user)
        {
            string issuer = _configuration[TokenBearIssuer];
            string audience = _configuration[TokenBearAudience];
            string signatureKey = _configuration[TokenBearSignatureKey];
